...
export const Env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_ASSISTANT_BASE_URL: z.string().optional(),
    NEXT_PUBLIC_USE_CUSTOM_SERVER_FOR_THREAD_PERSISTENCE: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_USE_CUSTOM_SERVER_FOR_THREAD_PERSISTENCE:
      process.env.NEXT_PUBLIC_USE_CUSTOM_SERVER_FOR_THREAD_PERSISTENCE,
